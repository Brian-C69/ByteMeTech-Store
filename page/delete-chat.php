...
// Delete chat (messages will be deleted via ON DELETE CASCADE)
$pdo->prepare("DELETE FROM support_chats WHERE CHAT_ID = :cid")->execute(["cid" => $chat_id]);

$_SESSION["success_message"] = "Chat deleted successfully.";
header("Location: customer-support.php");
exit;
